...
Finally, select genes from the High.ISGs group for GO and pathway analysis. You can use Dr. Y's clusterProfiler package or various online tools. For more enrichment visualization methods, see: <https://k.youshop10.com/sm2p0xYn>
