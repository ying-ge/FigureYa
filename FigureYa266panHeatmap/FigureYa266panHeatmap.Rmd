...
The output file TCGA_*_limma_test_result.tumor_vs_normal.txt from the "Differential Expression Analysis" section can be directly used with FigureYa59volcano<https://k.youshop10.com/QFx3=Jj1> to create high-quality volcano plots.
