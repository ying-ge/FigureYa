...
Here are a few examples of how we crowdfunded:
...
- Single-cell data. sc.seurat.Rdata, file obtained from single-cell RNA-seq pretreatment. The file size is large and has been uploaded to the Weiyun <https://share.weiyun.com/vZiSM9pB>. How do I get this document? Drag to the end of the article to see "Attached: Single-cell RNA-seq data preprocessing"
