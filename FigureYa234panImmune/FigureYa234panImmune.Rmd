...
The data is from UCSC xena Pan-cancer, and the process from data download to obtaining the above two files is described in 'TCGA_pan. R' (located in the current folder). The file is too large and has been uploaded to Weiyun https://share.weiyun.com/g2BTNgVX
