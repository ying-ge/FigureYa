...
The large data used in the article has been uploaded to Baidu Cloud, link:< https://pan.baidu.com/s/1mpYgfy1cCZPQPzmkv4VQDA >Extract code: ibzk.

Including expression profile data of 19 immune cell lines, GENECODE annotation files, and RefSeq annotation files.
