...
# 下面代码安装或下载后本地安装
# Install with the following code or download for local installation
...
# BRB ArrayTools 软件的R语言版本，需要windows系统
# an R version of BRB ArrayTools software, requires Windows system
