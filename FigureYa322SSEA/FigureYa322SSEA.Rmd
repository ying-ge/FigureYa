...
TCGA-READ.htseq_counts.tsv.gz, TCGA-COAD.htseq_counts.tsv.gz - Expression profiles (eset). Large files available for download at: <https://www.yuque.com/figureya/figureyaplus/easyinput>. For other TCGA cancer type expression data, visit XENA: <https://xenabrowser.net/datapages/>
