...
B In the TCGA-CRC cohort (n = 584), the
determination of the optimal λ was obtained when the partial likelihood deviance reached the minimum value, and further generated Lasso coefficients of
the most useful prognostic genes. Data are presented as mean ± 95% confidence interval [CI]. 
...
TCGA.txt，GSE57303.txt，GSE62254.txt，数据集。行为样本，第一列为样本名，第二三列为生存时间和生存状态，后面的列均为基因。文件较大，已上传至微云<https://share.weiyun.com/y3qYgKCK>，或从语雀下载<https://www.yuque.com/figureya/figureyaplus/easyinput>
...
A_lasso.pdf可以把基因名标注在图上，方法可参考FigureYa31lasso<https://k.youshop10.com/BflugKvZ>
